#MUST watch this quick video on bipartite graphs algos:
...
def max_bipartite_matching_same_cardinality(bigraph):
    """Bipartie maximum matching
...
def max_bipartite_matching_different_cardinality(bigraph):
    """Bipartie maximum matching
    :param bigraph: adjacency list, index = vertex in U,
                                    value = neighbor list in V
...
#solution: https://codeforces.com/contest/489/submission/103168031