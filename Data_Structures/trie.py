...
class Trie():
    ...
    def search(self, word):
        """
        returns True iff word is in the Trie
        """
        root = self.root
        len1 = len(word)
    ...
    def delete(self, word):
        """
        returns -1 if the word is not in the Trie
        """
    ...
    def update(self, old_word, new_word):
        """
        does nothing if old_word is not in the Trie
        (ie doesnt add new_word in that case)
        """
...
if __name__ == "__main__":
    ...
    #"mnop" is not in the Trie so "pprt" is not added
    t.update("mnop", "pprt")
    print(t.search("pprt"))